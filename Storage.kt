...
class Storage {
    ...
    fun uploadImage(localFile: File, uuid: String, uploadSuccess:(Long)->Unit) {
        ...
        //This part is taken straight from the docs
    ...
    fun deleteImage(pictureUUID: String) {
        ...
        //Check if below is actually the pathstring
       uuid2StorageReference(pictureUUID).delete()
    }

    fun uuid2StorageReference(uuid: String): StorageReference {
        return photoStorage.child(uuid + ".jpg")
    }
}